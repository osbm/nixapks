...
| `buildGradleApkGradleDotNix` | [gradle-dot-nix](https://github.com/CrazyChaoz/gradle-dot-nix), per-app `verification-metadata.xml` | 1 | [mihon](apks/mi/mihon/package.nix) |
